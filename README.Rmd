...
As a multi-stock model, it is intended for use in fisheries where stock composition can not be readily identified in fishery data, e.g., catch and age/length composition.
Seasonal stock availability and movement can also be explicitly modeled with a multi-spatial area configuration.
